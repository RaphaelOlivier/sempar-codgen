...
from parse import parse, parse_tree_to_python_ast, canonicalize_code, get_grammar, parse_raw, \
    de_canonicalize_code, tokenize_code, tokenize_code_adv, de_canonicalize_code_for_seq2seq
from unaryclosure import get_top_unary_closures, apply_unary_closures
...
def parse_hs_dataset():
    ...
    annot_file = '/Users/pavvaru/Documents/Spring 2018/NNLP/Project/latest_code_generation/NL2code/lang/hearthstone/all_hs.mod.in'
    code_file = '/Users/pavvaru/Documents/Spring 2018/NNLP/Project/latest_code_generation/NL2code/lang/hearthstone/all_hs.out'
