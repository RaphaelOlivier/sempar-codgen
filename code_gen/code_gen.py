# python2 code_gen.py -data data/hs.freq3.pre_suf.unary_closure.bin -batch_size 10 -max_epoch 2 -valid_per_batch 280 -save_per_batch 280 -decode_max_time_step 350 -optimizer adadelta -rule_embed_dim 128 -node_embed_dim 64 -valid_metric bleu
...
if __name__ == '__main__':
    ...
    print(train_data.examples[0].query_tokens)
